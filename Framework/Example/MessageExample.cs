...
namespace Example
{
    public class MessageExample : Test
    {
        ...
        protected override void Start()
        {
            ...
            Framework.GetEnv(EnvironmentType.Ev0).modules.Message.processesPerFrame = 1;

            IMessage message = null;
            message = Framework.GetEnv(EnvironmentType.Ev0).modules.Message.Publish<Pub>(null)
                .SetCode(100)
                .OnRecycle((msg)=> {
        ...
        protected override void Update()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                Framework.GetEnv(EnvironmentType.Ev0).modules.Message.PublishByNumber(this, null, (int)key.Key - i)
