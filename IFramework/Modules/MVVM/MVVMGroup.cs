...
namespace IFramework.Modules.MVVM
{
    ...
    public class MVVMGroup : IDisposable
    {
        ...
        /// 消息转发
        /// </summary>
        public MessageModule message { get; private set; }
        /// <summary>
        /// VM
        /// </summary>
        ...
        protected virtual void OnRemoveMessage(MessageModule message)
        {
            (_viewModel as IViewModel).UnSubscribeMessage();
        }
        /// <summary>
        ...
        /// </summary>
        /// <param name="message"></param>
        protected virtual void OnSetMessage(MessageModule message)
        {
            (_viewModel as IViewModel).SubscribeMessage();
        }
        /// <summary>
